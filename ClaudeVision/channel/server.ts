...
const mcp = new Server(
  { name: 'visionclaude', version: '1.0.0' },
  {
    ...
    instructions: [
      ...
      'If NO file_path is present, the user is in voice-command mode (glasses mic only).',
      '',
      'VOICE COMMAND MODE INSTRUCTIONS:',
      '- The user is speaking through their glasses microphone.',
      '- They are giving you commands to execute on their PC.',
      '- Treat every message as an instruction to perform an action.',
      '- Use your terminal, file editing, git, and other tools to fulfill the request.',
      '- Respond concisely (1-2 sentences) — the response will be spoken aloud.',
      '',
